...
CREATE TABLE "Producto" (
    ...
    "unidadVenta3" TEXT,
    "precioVenta3" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "costoVenta3" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "factorVenta3" DOUBLE PRECISION NOT NULL DEFAULT 1,
    "unidadVenta4" TEXT,
    "precioVenta4" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "costoVenta4" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "factorVenta4" DOUBLE PRECISION NOT NULL DEFAULT 1,
