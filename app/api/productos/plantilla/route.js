...
export async function GET() {
  ...
  const headers = [
    'Nombre', 'Codigo', 'Codigo2', 'Codigo3', 'Precio', 'Costo', 'Stock', 'StockMinimo',
    'Unidad', 'Categoria',
  ...
  sheet.addRow(['Ejemplo Arroz', 'AR001', '7501234567', '7501234568', 15, 12, 100, 10, 'libra', 'Granos', 'quintal', 1200, 1000, 100, '', 0, 0, 1, '', 0, 0, 1, 'FALSE', 13, 12, '2026-12-31'])
